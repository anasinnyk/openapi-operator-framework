...
impl koof::api::ApiCredential for ApiEmailCredential {
    fn apply(&self, request: reqwest::RequestBuilder) -> reqwest::RequestBuilder {
        koof::api::ApiCredential::apply(&self.0, request)
    }
}
pub struct ApiKeyCredential(koof::api::HeaderCredential);
impl ApiKeyCredential {
    pub fn new(value: impl AsRef<str>) -> Result<Self, koof::error::CredentialError> {
        Ok(Self(koof::api::HeaderCredential::new("X-Auth-Key", value)?))
    }
}
impl koof::api::ApiCredential for ApiKeyCredential {
    fn apply(&self, request: reqwest::RequestBuilder) -> reqwest::RequestBuilder {
        koof::api::ApiCredential::apply(&self.0, request)
    }
}
pub struct ApiTokenCredential(koof::api::BearerCredential);
impl ApiTokenCredential {
    pub fn new(value: impl AsRef<str>) -> Result<Self, koof::error::CredentialError> {
        Ok(Self(koof::api::BearerCredential::new(value)?))
    }
}
impl koof::api::ApiCredential for ApiTokenCredential {
    fn apply(&self, request: reqwest::RequestBuilder) -> reqwest::RequestBuilder {
        koof::api::ApiCredential::apply(&self.0, request)
    }
}
...
impl ProviderClient {
    ...
    ) -> koof::api::ApiRequest<IamResponseSingleAccount> {
        #[allow(unused_mut)]
    ...
    pub fn account_deletion(
        &self,
        account_id: &str,
    ) -> koof::api::ApiRequest<IamApiResponseSingleId> {
        #[allow(unused_mut)]
    ...
    ) -> koof::api::ApiRequest<CreateZoneRulesetResponse> {
        #[allow(unused_mut)]
    ...
    pub fn get_zone_ruleset(
        ...
        ruleset_id: &str,
        zone_id: &str,
    ) -> koof::api::ApiRequest<GetZoneRulesetResponse> {
        #[allow(unused_mut)]
        let mut path = "/zones/{zone_id}/rulesets/{ruleset_id}".to_owned();
        path = path.replace("{ruleset_id}", urlencoding::encode(ruleset_id).as_ref());
        path = path.replace("{zone_id}", urlencoding::encode(zone_id).as_ref());
    ...
    ) -> koof::api::ApiRequest<PagesProjectCreateProjectResponse> {
        #[allow(unused_mut)]
    ...
    pub fn pages_project_delete_project(
        ...
        account_id: &str,
        project_name: &str,
    ) -> koof::api::ApiRequest<PagesProjectDeleteProjectResponse> {
        #[allow(unused_mut)]
    ...
    pub fn pages_project_get_project(
        ...
        account_id: &str,
        project_name: &str,
    ) -> koof::api::ApiRequest<PagesProjectGetProjectResponse> {
        #[allow(unused_mut)]
        let mut path = "/accounts/{account_id}/pages/projects/{project_name}".to_owned();
        path = path.replace("{account_id}", urlencoding::encode(account_id).as_ref());
        path = path.replace("{project_name}", urlencoding::encode(project_name).as_ref());
    ...
    ) -> koof::api::ApiRequest<PagesProjectUpdateProjectResponse> {
        #[allow(unused_mut)]
        let mut path = "/accounts/{account_id}/pages/projects/{project_name}".to_owned();
        path = path.replace("{account_id}", urlencoding::encode(account_id).as_ref());
        path = path.replace("{project_name}", urlencoding::encode(project_name).as_ref());
    ...
    ) -> koof::api::ApiRequest<UpdateZoneRulesetResponse> {
        #[allow(unused_mut)]
        let mut path = "/zones/{zone_id}/rulesets/{ruleset_id}".to_owned();
        path = path.replace("{ruleset_id}", urlencoding::encode(ruleset_id).as_ref());
        path = path.replace("{zone_id}", urlencoding::encode(zone_id).as_ref());
    ...
    ) -> koof::api::ApiRequest<Zones0PatchResponse> {
        #[allow(unused_mut)]
        let mut path = "/zones/{zone_id}".to_owned();
        path = path.replace("{zone_id}", urlencoding::encode(zone_id).as_ref());
        let url = format!("{}{}", self.base_url.trim_end_matches('/'), path,);
